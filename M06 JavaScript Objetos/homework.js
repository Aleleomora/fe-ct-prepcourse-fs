...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   Forma mas larga pero buena opcion para razonar el problema 
   */
  objetoProducto.calcularPrecioDescuento = function(){
   var objetoConDescuento = objetoProducto.precio - objetoProducto.precio * objetoProducto.porcentajeDeDescuento;
   return objetoConDescuento;
  }
  return objetoProducto;
}
